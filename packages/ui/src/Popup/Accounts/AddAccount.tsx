...
import { SvgPolyNew } from "@polymath/ui/assets/images/icons";
    ...
    <>
      <Header>
        <Box mt="l" pb="5">
          ...
          >
            <Icon Asset={SvgPolyNew} width={50} height={50} color="brandMain" />
          </Box>
          <Box pt="m" width={220}>
      ...
      <Box mt="m">
        <Button fluid onClick={onCreateAccount}>
          Create account
        </Button>
      </Box>
      <Box mt="s">
        <Button fluid variant="secondary" onClick={onImportSeed}>
          Import account from seed
        </Button>
      </Box>
      <Box mt="s">
        <Button fluid variant="ghost" onClick={onImportJson}>
