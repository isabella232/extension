...
import { Box, Button, ButtonSmall, Flex, Header, Heading, Icon, Text } from '@polymath/extension-ui/ui';
import { SvgArrowLeft, SvgCheckboxMarkedCircle, SvgClipboardListOutline, SvgCloseCircle } from '@polymath/extension-ui/assets/images/icons';
